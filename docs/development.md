---
title: Development
description: Learn how to develop and contribute to the Lando Python service
---

# Development

This guide contains information to help onboard developers to work on the [python](https://python.microsoft.com/en-us/) integration, hereafter referred to as *the plugin*.
...
```sh
# Clone this repo
git clone https://github.com/lando/python.git && cd python
...
This plugin contains various working and tested Lando apps in the [examples](https://github.com/lando/python/tree/main/examples) folder. You should use these or create new ones to help with plugin development.
...
This tells Lando that _this_ app should use the source version of the `@lando/python` plugin you cloned down in the installation. This is useful because it allows you to isolate development within this repo without interferring with any other apps using the stable and global version of the plugin.
